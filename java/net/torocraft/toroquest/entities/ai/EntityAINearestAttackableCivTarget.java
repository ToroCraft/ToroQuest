...
public class EntityAINearestAttackableCivTarget extends EntityAITarget {
	...
	protected boolean shouldExecutePlayer() {
		...
		targetEntity = taskOwner.worldObj.getNearestAttackablePlayer(taskOwner.posX, taskOwner.posY + (double) taskOwner.getEyeHeight(),
				taskOwner.posZ, maxXZDistance, maxYDistance, null, targetEntitySelector);

		return targetEntity != null;
	}

	protected boolean shouldExecuteNonPlayer() {
		List<EntityToroNpc> list = taskOwner.worldObj.<EntityToroNpc> getEntitiesWithinAABB(EntityToroNpc.class,
