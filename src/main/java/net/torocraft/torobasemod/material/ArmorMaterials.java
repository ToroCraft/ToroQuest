...
public class ArmorMaterials {
	...
	public static ArmorMaterial KING = EnumHelper.addArmorMaterial("KING", MODID + ":kingArmor", 36, new int[]{3, 8, 6, 3}, 25, null);
	public static ArmorMaterial HEAVY_DIAMOND = EnumHelper.addArmorMaterial("HEAVY_DIAMOND", MODID + ":heavyDiamondArmor", 30, new int[]{3, 8, 6, 3}, 5, null);
