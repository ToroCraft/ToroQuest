...
public class BounceModItems {
	...
	private static void initRubberSword() {
		...
		ModelResourceLocation rubberSwordModel = new ModelResourceLocation(MODID + ":" + ItemRubberSword.NAME, "inventory");
	...
	private static void initFlubberSword() {
		...
		ModelResourceLocation flubberSwordModel = new ModelResourceLocation(MODID + ":" + ItemFlubberSword.NAME, "inventory");
	...
	private static void initRubberArmor() {
		GameRegistry.registerItem(rubberHelmetItem = new ItemRubberArmor("rubber_helmet", 1, EntityEquipmentSlot.HEAD), "rubber_helmet");
		...
		GameRegistry.registerItem(rubberChestplateItem = new ItemRubberArmor("rubber_chestplate", 1, EntityEquipmentSlot.CHEST), "rubber_chestplate");
		ModelResourceLocation rubberChestplateModel = new ModelResourceLocation(MODID + ":" + "rubber_chestplate", "inventory");
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(rubberChestplateItem, 0, rubberChestplateModel);

		GameRegistry.registerItem(rubberLeggingsItem = new ItemRubberArmor("rubber_leggings", 2, EntityEquipmentSlot.LEGS), "rubber_leggings");
		ModelResourceLocation rubberLeggingsModel = new ModelResourceLocation(MODID + ":" + "rubber_leggings", "inventory");
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(rubberLeggingsItem, 0, rubberLeggingsModel);
		
		GameRegistry.registerItem(rubberBootsItem = new ItemRubberArmor("rubber_boots", 1, EntityEquipmentSlot.FEET), "rubber_boots");       
