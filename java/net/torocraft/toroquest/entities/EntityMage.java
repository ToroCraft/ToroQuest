...
public class EntityMage extends EntityMob implements IRangedAttackMob {
	...
	protected void handleAttackLogicUpdate() {
		...
		if (potiontype != null) {
			this.worldObj.playSound((EntityPlayer) null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITCH_DRINK, this.getSoundCategory(),
					1.0F, 0.8F + this.rand.nextFloat() * 0.4F);
	...
	protected void attackWithPotion(EntityLivingBase target) {
		...
		this.worldObj.playSound((EntityPlayer) null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITCH_THROW, this.getSoundCategory(), 1.0F,
